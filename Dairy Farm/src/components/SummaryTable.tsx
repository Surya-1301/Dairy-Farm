...
function SummaryTable({
  ...
  return (
    <div className="rounded-lg md:rounded-xl border border-slate-200 bg-white p-4 md:p-6 shadow-sm">
      ...
      <div className="grid gap-3 grid-cols-1 sm:grid-cols-3 md:grid-cols-3">
        ...
        <div className="rounded-lg bg-slate-50 p-3 md:p-4">
          <p className="text-xs uppercase text-slate-500 font-medium">Total Liters</p>
          <p className="text-xl md:text-2xl font-bold text-slate-800 mt-1">{totalLiters}</p>
        </div>
        <div className="rounded-lg bg-slate-50 p-3 md:p-4">
